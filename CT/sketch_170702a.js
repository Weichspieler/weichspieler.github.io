...
/*
  ...
  var allScores = data.val();
  var keys = Object.keys(allScores);
  console.log(keys);
  var html ="";
  for (var i = 0; i < keys.length; i++){
     var k = keys[i];
     var name = allScores[k].name;
     var score_ = allScores[k].score;
     var entry = name + ": " +score_
     var li = createElement('li', entry);
     li.class('scorelist');
     li.parent('scores');
...
*/
    ...
    //   var count = 0;
   // var li = createElement('li', child.val().name + ": " + child.val().score);
